...
public class EntityMagatiumBolt extends EntityThrowable
{
	public EntityMagatiumBolt(World world)
	{
		super(world);
	}

	public EntityMagatiumBolt(World world, EntityLivingBase thrower)
	{
		super(world, thrower);
	}
	...
	public void handleStatusUpdate(byte id)
	{
		if (id == 3)
		{
			this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.BLOCK_STONE_BREAK, SoundCategory.NEUTRAL, 1.0F, this.rand.nextFloat() * 0.5F + 0.25F, false);
	...
	protected void onImpact(RayTraceResult result)
	{
		...
		if (!this.world.isRemote && result != null)
		{
			...
			{
				result.entityHit.attackEntityFrom(this.thrower != null ? DamageSource.causeThrownDamage(this, this.thrower) : DamageSource.GENERIC, 7.5F);
