...
public class CommandRank extends CommandBase
{
	...
	{		
		return sender instanceof EntityPlayerMP ? DinocraftEntity.getEntity((EntityPlayerMP) sender).hasOpLevel(DinocraftConfig.PERMISSION_LEVEL_RANK) : true;
	}
	...
	{		
		if (args.length <= 1)
		{
			throw new WrongUsageException("commands.rank.usage");
		}
		else
		{
