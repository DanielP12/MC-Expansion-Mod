...
public final class Quat
{
	...
	public VectorHelper rotate(VectorHelper vec)
	{
		...
		return new VectorHelper(vx, vy, vz);
	}
	...
	public static Quat aroundAxis(VectorHelper axis, double angle)
	{
